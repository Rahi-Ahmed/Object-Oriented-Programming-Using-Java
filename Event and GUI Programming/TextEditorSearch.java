...
public class TextEditorSearch extends JFrame {
    ...
    public TextEditorSearch() {
        ...
        JMenuItem searchMenuItem = new JMenuItem("Search"); // Create a new menu item for searching a word
        ...
        fileMenu.add(searchMenuItem); // Add the search menu item to the file menu
        ...
        searchMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                searchWord();  // Call the searchWord() method when the search menu item is clicked
            }
        });
    }
    ...
    // Method to handle searching for a word
    private void searchWord() {
        String word = JOptionPane.showInputDialog(this, "Enter a word to search:");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                TextEditorSearch editor = new TextEditorSearch();  // Create a new instance of the TextEditor class
